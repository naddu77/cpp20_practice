...
public:
	...
	public:
		...
		// Non-copyable because coroutine handles point tot a unique resource
		...
		reference_type operator*() noexcept(noexcept(std::is_nothrow_copy_constructible_v<reference_type>))
		{
	...
	generator& operator=(generator const&& rhs) noexcept
	{
		swap(rhs);
